...
function defaultRenderer (props) {
  ...
  const resolvedShow = showCount % 2 === 0 ? showCount : showCount + 1

  const activeIndex = sortedGroupDatums.findIndex(d => d === datum)
  const start = activeIndex > -1 ? activeIndex - showCount / 2 : 0
  const end = activeIndex > -1 ? start + showCount / 2 : showCount
