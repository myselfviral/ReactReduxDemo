...
function defaultRenderer (props) {
  ...
  const start =
    activeIndex > -1
      ? Math.min(Math.max(activeIndex - showCount / 2, 0), sortedGroupDatums.length - showCount)
      : 0
  const end = activeIndex > -1 ? Math.min(start + showCount, sortedGroupDatums.length) : showCount
