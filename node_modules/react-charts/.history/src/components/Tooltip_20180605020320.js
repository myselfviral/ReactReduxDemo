...
class Tooltip extends React.PureComponent {
  ...
  componentDidUpdate (oldProps) {
    ...
    if (!oldProps.tooltip.opacity && this.props.tooltip.opacity) {
  ...
  updateTooltip = force => {
    ...
    if (this.focusDatum === focusDatum && this.active === active && !force) {
      return
    }
        ...
        >
          ...
          >
            <div
              ref={el => {
                this.tooltipEl = el
                console.log(this.tooltipEl, this.needsReposition)
                if (this.tooltipEl && this.needsReposition) {
                  const looker = setInterval(() => {
                    if (
                      (this.tooltipEl && console.log(this.tooltipEl.getBoundingClientRect())) ||
                      this.tooltipEl.getBoundingClientRect().width > 0
                    ) {
                      clearInterval(looker)
                      console.log('hello')
                      RAF(() => this.updateTooltip(true))
                    }
                  }, 16)
                  setTimeout(() => {
                    clearInterval(looker)
