...
class Chart extends Component {
  ...
  getState () {
    return {
      ...
      gridWidth: this.selectors.gridWidth(this.state),
      gridHeight: this.selectors.gridHeight(this.state),
      gridX: this.selectors.gridX(this.state),
      gridY: this.selectors.gridY(this.state),
      offset: this.selectors.offset(this.state),
    }
  }
  render () {
    const {
    ...
    const { gridX, gridY } = this.getState()
