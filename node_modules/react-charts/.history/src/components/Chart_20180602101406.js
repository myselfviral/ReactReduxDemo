...
class ChartState extends React.Component {
  constructor () {
    super()
    this.state = {
      dispatch: (...args) => this.setState(...args),
    }
  }
  static getDerivedStateFromProps (props, state) {
    if (
      (Utils.shallowCompare(props, state), [data, interaction, hoverMode, groupMode, showVoronoi])
    ) {
      return {
        data,
        interaction,
...
export default props => (
  <HyperResponsive
    render={({ handleRef, width, height }) => (
      <ChartState {...props} width={width} height={height} handleRef={handleRef} />
    )}
  />
)
