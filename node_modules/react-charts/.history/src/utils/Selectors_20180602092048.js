...
export default {
  ...
  gridY: () =>
    Memoize(
      state => [state && state.padding && state.padding.top, state && state.axesDimensions],
      (paddingTop, axesDimensions) => {
        const axesTopHeight =
          (axesDimensions && axesDimensions.top && sumObjBy(state.axesDimensions.top, 'height')) ||
          0
        const axesLeftTop =
          (axesDimensions && axesDimensions.left && sumObjBy(state.axesDimensions.left, 'top')) || 0
        const axesRightTop =
          (axesDimensions && axesDimensions.right && sumObjBy(state.axesDimensions.right, 'top')) ||
          0
