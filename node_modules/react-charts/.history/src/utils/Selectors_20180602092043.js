  ...
  gridY: () =>
    Memoize(
      ...
      (paddingTop, axesDimensions) => {
        const axesTopHeight =
          (axisDimensions && axisDimensions.top && sumObjBy(state.axisDimensions.top, 'height')) ||
          0
        const axesLeftTop =
          (axisDimensions && axisDimensions.left && sumObjBy(state.axisDimensions.left, 'top')) || 0
        const axesRightTop =
          (axisDimensions && axisDimensions.right && sumObjBy(state.axisDimensions.right, 'top')) ||
          0
