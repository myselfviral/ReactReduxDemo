...
import Api from '../apis/TicketApi';
import * as types from '../../actions/actionConstants';
import { anchorTable } from '../../containers/Tables/demos/AnchorTable/TicketData';
const branch = 'ticket';
...
export function* watchFetchDatas(action) {
  ...
  try {
    const data = yield Api.getTickets().then(response => response.json());
    yield put(fetchActionSuccess(data.tickets, action.branch));
  } catch (e) {    
