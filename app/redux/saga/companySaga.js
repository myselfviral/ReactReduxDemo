...
import Api from '../apis/CompanyApi';
import * as types from '../../actions/actionConstants';
import { anchorTable } from '../../containers/Tables/demos/AnchorTable/CompanyData';
...
export function* watchFetchDatas(action) {
  ...
  try {
    const data = yield Api.getCompanies().then(response => response.json());
    yield put(fetchActionSuccess(data.companies, action.branch));
  } catch (e) {    
